 ...
 * contents of gzip.xs. Do not edit this file, edit gzip.xs instead.
 *
...
extern "C"
#endif
XS_EXTERNAL(boot_PerlIO__gzip); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_PerlIO__gzip)
{
    dVAR; dXSARGS;
