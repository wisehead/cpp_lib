...
extern PROTOBUF_INTERNAL_EXPORT_Person_2epro ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_Person_2epro;
extern PROTOBUF_INTERNAL_EXPORT_Person_2epro ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_Person_2epro;
namespace tutorial {
...
static void InitDefaultsscc_info_AddressBook_Person_2epro() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AddressBook_Person_2epro =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_AddressBook_Person_2epro}, {
      &scc_info_Person_Person_2epro.base,}};

static void InitDefaultsscc_info_Person_Person_2epro() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_Person_2epro =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Person_Person_2epro}, {
      &scc_info_Person_PhoneNumber_Person_2epro.base,}};

static void InitDefaultsscc_info_Person_PhoneNumber_Person_2epro() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_Person_2epro =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_PhoneNumber_Person_2epro}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Person_2epro[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_Person_2epro[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_Person_2epro = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Person_2epro::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Person_2epro[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nPerson.pro\022\010tutorial\"\324\001\n\006Person\022\014\n\004nam"
  ...
  "Personb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_Person_2epro_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Person_2epro_sccs[3] = {
  &scc_info_AddressBook_Person_2epro.base,
  &scc_info_Person_Person_2epro.base,
  &scc_info_Person_PhoneNumber_Person_2epro.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Person_2epro_once;
static bool descriptor_table_Person_2epro_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Person_2epro = {
  &descriptor_table_Person_2epro_initialized, descriptor_table_protodef_Person_2epro, "Person.pro", 294,
  &descriptor_table_Person_2epro_once, descriptor_table_Person_2epro_sccs, descriptor_table_Person_2epro_deps, 3, 0,
  schemas, file_default_instances, TableStruct_Person_2epro::offsets,
  file_level_metadata_Person_2epro, 3, file_level_enum_descriptors_Person_2epro, file_level_service_descriptors_Person_2epro,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Person_2epro = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Person_2epro), true);
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_Person_2epro);
  return file_level_enum_descriptors_Person_2epro[0];
}
...
void Person_PhoneNumber::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_PhoneNumber_Person_2epro.base);
  number_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_ = 0;
}
...
void Person::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_Person_2epro.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  email_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  id_ = 0;
}
...
void AddressBook::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AddressBook_Person_2epro.base);
}
